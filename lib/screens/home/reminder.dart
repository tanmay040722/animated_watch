...
class _NoteThumbnailState extends State<NoteThumbnail> {
  ...
  Future<DateTime> _selectDate(BuildContext context) async {
    ...
    if (date != null) {
      ...
      if (time != null) {
        setState(() {
          fullDate =  DateTime(date.year, date.month, date.day, time.hour, time.minute);//DateTimeField.combine(date, time);
        });
        //TODO
      ...
      return DateTime(date.year, date.month, date.day, time!.hour, time.minute);//DateTimeField.combine(date, time);
    } else {
      return selectedDate;
    }
  }
